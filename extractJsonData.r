...
# Mac path
setwd("/Users/bryan/Documents/Master/Méthode en SC1 Mesures comportementales/Project/SC1_Project/SC1_Project-master/data")
files <- list.files("/Users/bryan/Documents/Master/Méthode en SC1 Mesures comportementales/Project/SC1_Project/SC1_Project-master/data")
